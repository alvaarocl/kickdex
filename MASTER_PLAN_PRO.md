...
- [ ] **Dropping Odds:** Sistema de detección de caídas de datos externos drásticas.
...
- [x] **Match Components:** Componentes reactivos para partidos y datos externos.
- [ ] **Interactive Charts:** Mapas de calor de tiros y gráficos de momentum.

## 🤖 FASE 4: AUTOMATIZACIÓN & ALERTAS
- [ ] **Telegram Bot Integration:** Recibir alertas de datos configuradas directamente en el chat.
